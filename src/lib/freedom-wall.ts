...
const seed = [
  [
    "To whoever returned my flash drive at the CAS lobby — you saved my whole semester. Salamat kaayo!",
    "Mika, BSIT 2",
    "appreciation",
    "yellow",
    28,
  ...
  [
    "Study tip: explain the lesson to a plant. If the plant looks confused, review chapter 3 again.",
    "Anonymous yarn?",
    "funny",
    "mint",
    41,
  ...
  [
    "Manifesting a campus shuttle that arrives exactly when we leave the classroom. ✨",
    "Jules",
    "student-life",
    "blue",
    34,
  ...
  [
    "Your pace is still progress. Rest is part of the work, not the opposite of it.",
    "A tired senior",
    "experiences",
    "lilac",
    56,
  ...
  [
    "Shoutout to the kuya at the kiosk who remembers everyone’s usual order.",
    "Anonymous yarn?",
    "appreciation",
    "pink",
    22,
  ...
  [
    "Proposal: more charging corners under shady trees. Group study, but make it presko.",
    "Ivy",
    "ideas",
    "peach",
    37,
  ...
  [
    "The walk from Engineering to the next class is my daily cardio program.",
    "Late since 8:01",
    "funny",
    "yellow",
    63,
  ...
  [
    "One day, I’ll build technology that helps Mindanao farmers make better decisions.",
    "Future dev",
    "dreams",
    "mint",
    49,
  ...
  [
    "Found my people in a random lab group. College surprises you in kind ways.",
    "N",
    "experiences",
    "pink",
    31,
  ...
  [
    "Reminder: save your file. Then save it again. Then email it to yourself.",
    "Your lab guardian",
    "student-life",
    "blue",
    71,
  ...
  [
    "What song is carrying you through midterms? Mine is the printer startup sound.",
    "Anonymous yarn?",
    "random",
    "lilac",
    18,
  ...
  [
    "I hope our orgs collaborate on a campus-wide creative tech day next semester.",
    "Kai",
    "ideas",
    "peach",
    25,
  ...
  [
    "To everyone quietly trying their best: I see you. Padayon.",
    "Someone cheering",
    "appreciation",
    "yellow",
    84,
  ...
  [
    "Dear future me: you made it through the thesis defense. Please buy present me coffee.",
    "BSIT 4",
    "dreams",
    "blue",
    46,
